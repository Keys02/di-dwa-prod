...
function MainApp() {
  ...
  const noLayoutRoutes = ["/signup", "/login",  "/myorder", "/admin","/contactus","/about", "/track", "/payment", "/forgotpassword"];

  const shouldShowLayout = !noLayoutRoutes.includes(location.pathname.toLowerCase());
  return (
