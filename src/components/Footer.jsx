...
const Footer = () => {
  ...
  const aboutLinks = [
    { name: 'How It Work', path: '/About' },
    { name: 'Our Products', path: '/categories' },
    { name: 'Special Offers', path: '/categories' }
  ];

  const helpLinks = [
    { name: 'Payments', path: '/Payment' },
    { name: 'Delivery', path: '/Track' },
    { name: 'Product Returns', path: '/ContactUs' },
    { name: 'FAQs', path: '/ContactUs' },
    { name: 'Checkout', path: '/categories' },
    { name: 'Other Issues', path: '/ContactUs' }
  ];
